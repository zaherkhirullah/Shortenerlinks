...
class AdminController extends Controller
{
	...
	{   
		...
		{   
			...
			$TheDate =$date->year.'-'.$date->month.'-'.$i;
			$link_views = $view->AlldateLinkViews($TheDate);
			$file_downloads = $download->AlldateFileDownloads($TheDate);
			$files_links_count->addRow([$TheDate, $link_views , $file_downloads]); 
		}
