		...
		<section class="hbox stretch">
				<section class="vbox">
					<section class="scrollable wrapper">
						...
						<form method="POST" action="/user/account/change-password" accept-charset="UTF-8"><input name="_token" type="hidden" value="1m4qlv29NhVRkvO9Rse6NZQqpM2HLI8g8r4Hzp8l">
