  ...
  <section class="lter box box-success">
    ...
    <section class="box-body">   
      ...
      <table class="table table-striped table-hover table-flip-scroll cf">
        <tbody>
          ...
          <tr>
            ...
            <td class="v-middle hidden-xs">
              ...
              <div class="pos-rlt">
                <button class="btn btn-copy text-success" data-clipboard-text="{{$link->shorted_url}}"
                 data-toggle="button">
                 <span class="text">
         ...
         <td class="pull-right">
          <a href="#edit-link-{{$link->id}}" data-toggle="modal"
          class="text-success" >
          <span class="text">
        ...
        <a href="#delete-link-{{$link->id}}" data-toggle="modal" class=" text-danger" >
          <span class="text">
