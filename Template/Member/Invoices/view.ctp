                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <?=
                                    $this->Form->input('stripe_exp_month', [
                                ...
                                <div class="col-sm-6">
                                    <?=
                                    $this->Form->input('stripe_exp_year', [
...
<script>
    ...
    checkout_form.on("change", function (e) {
        ...
        $(this).find(".payment-method-details[data-paymentmethod='" + payment_method + "']")
            .css("display", "block");
    });
</script>
<?php $this->end(); ?>
